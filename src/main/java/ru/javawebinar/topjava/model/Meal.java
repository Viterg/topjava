...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.WITH_USER, query = "SELECT m FROM Meal m LEFT JOIN FETCH m.user WHERE m.id=:id AND m.user.id=:userId"),
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String WITH_USER = "Meal.getWithUser";
